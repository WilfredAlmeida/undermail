<script>
  ...
  <main class="flex items-center justify-center h-screen bg-gradient-to-b from-pink-400 to-purple-900">
    <div class="grid grid-cols-2 gap-6 bg-white bg-opacity-20 rounded-lg p-8 backdrop-blur-lg shadow-lg">
      <!-- Left Side -->
